# Node.js 프로그래밍
* GitHub URL: (https://github.com/uzoolove/frontend-nodejs)
...
3. Github 레퍼지토리 복사
	...
	* <nohyper>https</nohyper>://github.com/uzoolove/frontend-nodejs.git 입력
	* 복사할 적당한 폴더 선택 후 Select as Repository Destination 선택
	* Open 선택
4. 샘플 코드 복사
	* workspace 폴더 생성 후 sample 폴더 내부 파일을 workspace 폴더에 복사 후 개발 시작
    - 강사의 완성된 코드는 workspace-ins 폴더에서 확인 가능
